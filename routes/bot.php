...
",
    ...
    ->addRoute("/help|.*Консультация онлайн", function ($message) {
        MilitaryServiceFacade::bot()->inlineKeyboard("Здравствуйте!\n
...
Для связи с разбработчиками системы:

", [
            [
                ["text" => "\xE2\x9C\x85Инста Donbass IT", "url" => "https://www.instagram.com/donbass.it/"]
            ],
            [
                ["text" => "\xE2\x9C\x85Группа в ВК", "url" => "https://vk.com/do_real_it"]
            ]
