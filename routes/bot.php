...
MilitaryServiceFacade::bot()
    ...
    ->addRoute("/start|.*Меню|.*menu", function ($message) {
        ...
        MilitaryServiceFacade::bot()->replyKeyboard(
            "🔈Приветствуем Вас в чат-боте НД ДНР.

⚡️Благодаря «Щиту» вы сможете:
▫️узнать адреса бомбоубежищ город и районов ДНР;
▫️добавить адрес нового убежища;
▫️добавить точку сбора гуманитарной помощи;
▫️оказать помощь вещами, продуктами или медикаментами;
▫️помочь с организацией питания нуждающихся людей и их транспортировкой;
▫️стать волонтёром;
▫️отправить заявку на поиск людей в освобождённых н.п. и написать письмо близким и родным.

@nddnr - наш канал оперативных новостей
