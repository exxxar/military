...
Обновления (13.04):
- теперь родственики смогут получить все ваши сообщения через терминалы операторов, выдающих гум. помощь,
так что писать можно несколько сообщений, все они точно дойдут до адресата
